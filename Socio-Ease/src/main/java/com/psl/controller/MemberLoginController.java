...
public class MemberLoginController {
	...
	public String addMember(Model model) {
		SocietyMember s = new SocietyMember();
		model.addAttribute("societymember",s);
		return "addMember";
	}
	
	@PostMapping("/addmember")
	public String addMemberPost(Model model,@ModelAttribute SocietyMember s, BindingResult results) {
		service.addSocietyMember(s);
